...
from .views import (LoginView, RegisterView, UsersView, CurrentUserView, 
                   IsActiveView, AdminLoginView)
...
urlpatterns = [
    ...
    path('login', LoginView.as_view(), name='login'),  # Handle without slash
    path('login/', LoginView.as_view(), name='login_with_slash'),  # Handle with slash
]
