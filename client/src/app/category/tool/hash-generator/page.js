...
export default function Page() {
  ...
  const handleGenerateHashes = async (event) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/tools/hash-generator/`,
        { original_text: text },
        {
          headers: {
      ...
      <div className="bg-background rounded-lg border p-6 w-full mt-5">
        ...
        {hashInfo && (
          <div className="mt-4">
            <p className="text-lg font-medium text-gray-900">
              Original Text: {hashInfo.original_text}
            </p>
            <div className="mt-4">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">MD5</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">Base64</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">
                          {hashInfo.base64}
                    ...
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">Bcrypt</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">
                          {hashInfo.bcrypt}
                    ...
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">SHA1</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">
                          {hashInfo.sha1}
                    ...
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">SHA256</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">
                          {hashInfo.sha256}
        ...
        {!hashInfo && (
          <p className="mt-4 text-sm text-muted-foreground">
            Results will be shown here once you generate hashes.
          </p>
        )}
      </div>
    </div>
